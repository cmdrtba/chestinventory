...
namespace PhotonPackageParser
{
    public abstract class PhotonParser
    {
        ...
        protected abstract void OnRequest(byte code, Dictionary<byte, object> parameters);

        protected abstract void OnResponse(byte code, short returnCode, string debugMessage, Dictionary<byte, object> parameters);
